...
<head>
    ...
    <title>LearnProg - Admin Dashboard</title>
...
<body class="sb-nav-fixed">
	...
	<div id="layoutSidenav_content">
		<main>
			<div class="container-fluid px-4">
				...
				?>
		        <?php include "../content/ad-chart-section.php"; ?>
		        <?php include "../content/ad-users-table.php"; ?>
			</div>
		</main>
	...
	<script src="../js/chart-area-admin-panel.js"></script>
	<script src="../js/chart-bar-admin-panel.js"></script>
